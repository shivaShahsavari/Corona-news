...
import FastText
import polarity_analysis.polarity_analysis
import pandas as pd
import numpy as np
### READ ###
# read the train data 
...
#dutch_news_topics['final_tag'] = np.where(dutch_news_topics['probability_headline']>0.8,dutch_news_topics['label_headline'], dutch_news_topics['final_tag'])
#dutch_news_topics['final_tag'] = np.where(dutch_news_topics['probability_content']>0.8,dutch_news_topics['label_content'], dutch_news_topics['final_tag'])
#dutch_news_topics['final_tag'] = np.where(dutch_news_topics['f_probability_headline']>0.8,dutch_news_topics['f_label_headline'], dutch_news_topics['final_tag'])
#dutch_news_topics['final_tag'] = np.where(dutch_news_topics['f_probability_content']>0.8,dutch_news_topics['f_label_content'], dutch_news_topics['final_tag'])
